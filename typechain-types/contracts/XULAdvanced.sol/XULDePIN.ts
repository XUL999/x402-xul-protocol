...
export namespace DeviceRegisteredEvent {
  export type InputTuple = [id: BigNumberish, deviceType: BigNumberish];
  export type OutputTuple = [id: bigint, deviceType: bigint];
...
export interface XULDePIN extends BaseContract {
  ...
  registerDevice: TypedContractMethod<
    [deviceType: BigNumberish, computePower: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[reward: BigNumberish], [bigint], "nonpayable">;
  getFunction(
  ...
  filters: {
    "DeviceRegistered(uint256,uint8)": TypedContractEvent<
      DeviceRegisteredEvent.InputTuple,
      DeviceRegisteredEvent.OutputTuple,
      DeviceRegisteredEvent.OutputObject
    >;
