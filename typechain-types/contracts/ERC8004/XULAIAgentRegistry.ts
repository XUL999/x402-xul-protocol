...
export declare namespace XULAIAgentRegistry {
...
export interface XULAIAgentRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "agentActions"
      | "agents"
...
export namespace ActionRecordedEvent {
  export type InputTuple = [agentId: BigNumberish, zkProof: BytesLike];
  export type OutputTuple = [agentId: bigint, zkProof: string];
...
export interface XULAIAgentRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): XULAIAgentRegistry;
  waitForDeployment(): Promise<this>;

  interface: XULAIAgentRegistryInterface;
  ...
  createAgent: TypedContractMethod<
    [name: string, modelType: string, configHash: string],
    [bigint],
    "nonpayable"
  >;
  ...
  getAgent: TypedContractMethod<
    ...
    [XULAIAgentRegistry.AIAgentStructOutput],
    "view"
  >;

  getAgentActions: TypedContractMethod<
    [agentId: BigNumberish],
    [XULAIAgentRegistry.ActionRecordStructOutput[]],
    "view"
  >;
  ...
  filters: {
    "ActionRecorded(uint256,bytes32)": TypedContractEvent<
      ActionRecordedEvent.InputTuple,
      ActionRecordedEvent.OutputTuple,
      ActionRecordedEvent.OutputObject
    >;
