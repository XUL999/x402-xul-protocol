...
export interface XULSwapFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface XULSwapFactory extends BaseContract {
  connect(runner?: ContractRunner | null): XULSwapFactory;
  waitForDeployment(): Promise<this>;

  interface: XULSwapFactoryInterface;
