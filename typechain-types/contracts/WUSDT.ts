...
export interface WUSDTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addBridge"
      | "allowance"
...
export interface WUSDT extends BaseContract {
  connect(runner?: ContractRunner | null): WUSDT;
  waitForDeployment(): Promise<this>;

  interface: WUSDTInterface;
  ...
  bridges: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
