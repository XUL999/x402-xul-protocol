...
export interface WXULInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WXUL extends BaseContract {
  connect(runner?: ContractRunner | null): WXUL;
  waitForDeployment(): Promise<this>;

  interface: WXULInterface;
